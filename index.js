...
const orderDetails = { userId: 'user-123', productIds: [1, 3], shippingInfo: '123 Main St', amount: 99.99 };
...
// We need to ensure the product has an ID for removal to work in CartService
newLaptop.id = 999;
